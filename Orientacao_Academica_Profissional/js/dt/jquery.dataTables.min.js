...
(function(f) {
    ...
    function lb(a) {
        if (!q.__browser) {
            var b = {};
            q.__browser = b;
            var c = f("<div/>").css({position: "fixed", top: 0, left: -1 * f(z).scrollLeft(), height: 1, width: 1,
                overflow: "hidden"}).append(f("<div/>").css({position: "absolute", top: 1, left: 1, width: 100, overflow: "scroll"}).append(f("<div/>").css({width: "100%", height: 10}))).appendTo("body"), d = c.children(), e = d.children();
    ...
    function I(a, b, c, d) {
        ...
        if (f === p)
            return a.iDrawError != e && null === k && (O(a, 0, "Requested unknown parameter " + ("function" == typeof h.mData ? "{function}" : "'" + h.mData + "'") + " for row " + b + ", column " + c, 4), a.iDrawError = e), k;
    ...
    function S(a) {
        ...
        if (-1 !== f.inArray(!1, b))
            ...
            if (0 !== l.length)
                ...
                c = h.sZeroRecords, 1 == a.iDraw && "ajax" == D(a) ? c = h.sLoadingRecords : h.sEmptyTable && 0 === a.fnRecordsTotal() && (c = h.sEmptyTable), b[0] = f("<tr/>", {"class": e ? d[0] : ""}).append(f("<td />", {valign: "top", colSpan: W(a), "class": a.oClasses.sRowEmpty}).html(c))[0];
    ...
    function ub(a) {
        var b = a.oClasses, c =
                a.sTableId, d = a.oLanguage, e = a.oPreviousSearch, h = a.aanFeatures, g = '<input type="search" class="' + b.sFilterInput + '"/>', k = d.sSearch;
    ...
    function yb(a) {
        ...
        var h = a.aanFeatures;
        d || c.fnInit(a, b, e);
        h.p || (b.id = a.sTableId + "_paginate", a.aoDrawCallback.push({fn: function(a) {
                if (d) {
    ...
    function wb(a) {
        ...
        if ("" === c.sX && "" === c.sY)
            return a.nTable;
        var d = c.sX, e = c.sY,
                h = a.oClasses, g = b.children("caption"), k = g.length ? g[0]._captionSide : null, l = f(b[0].cloneNode(!1)), n = f(b[0].cloneNode(!1)), m = b.children("tfoot");
        m.length || (m = null);
    ...
    function na(a) {
        ...
        k = a.nScrollBody;
        var m = f(k), w = k.style, u = f(a.nScrollFoot).children("div"), q = u.children("table"), t = f(a.nTHead), r = f(a.nTable), v = r[0], za = v.style, T = a.nTFoot ? f(a.nTFoot) : null, A = a.oBrowser,
    ...
    function Ja(a) {
        ...
        if (d || !u && !h && !e && k == W(a) && k == n.length)
            ...
            for (q = 0; q < l.length; q++)
                r = c[l[q]], n[q].style.width = null !== r.sWidthOrig && "" !== r.sWidthOrig ? B(r.sWidthOrig) : "", r.sWidthOrig && h && f(n[q]).append(f("<div/>").css({width: r.sWidthOrig, margin: 0, padding: 0, border: 0, height: 1}));
            if (a.aoData.length)
                for (q = 0; q < l.length; q++)
    ...
    var q = function(a) {
        ...
        this.each(function() {
            ...
            if ("table" !=
                ...
                y.sUrl && (f.ajax({dataType: "json", url: y.sUrl, success: function(a) {
                        Ga(a);
                        L(m.oLanguage, a);
                        f.extend(!0, y, a);
                        ja(r)
                ...
                if (z.length) {
                    ...
                    f(z[0]).children("th, td").each(function(a, b) {
                        ...
                        if (c.mData === a) {
                            ...
                            if (null !== d || null !== b)
                                c.mData = {_: a + ".display", sort: null !== d ? a + ".@data-" +
                                            d : p, type: null !== d ? a + ".@data-" + d : p, filter: null !== b ? a + ".@data-" + b : p}, ma(r, a)
                        }
                    })
                }
                var C = r.oFeatures;
    ...
    q.Api = v;
    f.extend(v.prototype, {any: function() {
            return 0 !== this.count()
            ...
            for (h = f.length; m < h; m++) {
                ...
                if ("table" === b) {
                    ...
                    for (g = t.length; x < g; x++)
                        u = t[x], u = "cell" === b ? c.call(q, f[m], u.row,
        ...
        0 < J(c, "_details").length && (b.on("draw.dt.DT_details", function(d, e) {
            ...
            if (a === e)
                for (e = W(e), f = 0, g = c.length; f < g; f++)
                    b = c[f], b._details && b._details.children("td[colspan]").attr("colspan",
                            e)
    ...
    t("search()", function(a, b, c, d) {
        ...
        return a === p ? 0 !== e.length ? e[0].oPreviousSearch.sSearch : p : this.iterator("table", function(e) {
            e.oFeatures.bFilter && ia(e, f.extend({}, e.oPreviousSearch, {sSearch: a + "", bRegex: null === b ? !1 : b, bSmart: null ===
                        c ? !0 : c, bCaseInsensitive: null === d ? !0 : d}), 1)
        })
    });
    ...
    q.models.oColumn = {idx: null, aDataSort: null, asSorting: null, bSearchable: null, bSortable: null, bVisible: null, _sManualType: null, _bAttrSrc: !1, fnCreatedCell: null, fnGetData: null, fnSetData: null, mData: null, mRender: null, nTh: null, nTf: null, sClass: null, sContentPadding: null,
    ...
    q.defaults = {aaData: null, aaSorting: [[0, "asc"]], aaSortingFixed: [], ajax: null, aLengthMenu: [10, 25, 50, 100], aoColumns: null, aoColumnDefs: null, aoSearchCols: [], asStripeClasses: null, bAutoWidth: !0, bDeferRender: !1, bDestroy: !1, bFilter: !0, bInfo: !0, bLengthChange: !0, bPaginate: !0, bProcessing: !1, bRetrieve: !1, bScrollCollapse: !1, bServerSide: !1, bSort: !0, bSortMulti: !0, bSortCellsTop: !1,
        ...
        }, fnStateSaveParams: null, iStateDuration: 7200, iDeferLoading: null, iDisplayLength: 10, iDisplayStart: 0, iTabIndex: 0, oClasses: {}, oLanguage: {oAria: {sSortAscending: ": Pesquisa Ascendente", sSortDescending: ": Activação de Pesquisa de Ordem Descendente"}, oPaginate: {sFirst: "Primeiro", sLast: "Ultimo",
                sNext: "Próximo", sPrevious: "Anterior"}, sEmptyTable: "Nenhum Registo Encontrado", sInfo: "Mostrando _START_ de_END_ para _TOTAL_ Registos", sInfoEmpty: "Mostrando 0 entre 0 de 0 Registos", sInfoFiltered: "(Pesquisa para _MAX_ total de Registos)", sInfoPostFix: "", sDecimal: "", sThousands: ",", sLengthMenu: "Mostrar _MENU_ Registos", sLoadingRecords: "Processando...", sProcessing: "Processando...", sSearch: "Pesquisar:", sSearchPlaceholder: "", sUrl: "", sZeroRecords: "Nenhum Registo Encontrado"}, oSearch: f.extend({}, q.models.oSearch), sAjaxDataProp: "data",
    ...
    var Pb = q.ext.pager;
    f.extend(Pb, {simple: function(a, b) {
    ...
    f.extend(!0, q.ext.renderer, {pageButton: {_: function(a, b,
                    c, d, e, h) {
    ...
    Ha("");
    f.extend(!0, q.ext.renderer, {header: {_: function(a, b, c, d) {
