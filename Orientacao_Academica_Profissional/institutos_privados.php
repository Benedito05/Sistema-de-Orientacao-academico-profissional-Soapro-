                        ...
                        <div class="courses_search_container">
                            <form action="ver_curso_faculdade.php" method="POST" id="courses_search_form" class="courses_search_form d-flex flex-row align-items-center justify-content-start">
                                ...
                                <select name="id_instituicao" style="width: 100%" id="id_universidade" class=" chosen-select">
                                    ...
                                    <option>Pesquise o instituto Privado </option>

                                    <?php
                                    $result_fau = "SELECT * FROM instituicao_sup where sector='Privada' AND id_tipo=2  ORDER BY id_instituicao";
                                 ...
                                 <div class="sidebar">
                                         ...
                                         <ul class='pagination text-center' id="pagination">
                                             <?php if (!empty($total_pages)) : for ($i = 1; $i <= $total_pages; $i++) :
                                                     if ($i == 1) : ?>
                                                         <li class='active' id="<?php echo $i; ?>"><a href='pagination3.php?page=<?php echo $i; ?>'><?php echo $i; ?></a></li>
                                                     <?php else : ?>
                                                         <li id="<?php echo $i; ?>"><a href='pagination3.php?page=<?php echo $i;?>'><?php echo $i; ?></a></li>
                                                     <?php endif; ?>
                                             <?php endfor;
                                             endif; ?>
                                     </div>
...
<script>
    jQuery(document).ready(function() {
        jQuery("#target-content").load("pagination3.php?page=1");
        jQuery("#pagination li").live('click', function(e) {
            ...
            var pageNum = this.id;
            jQuery("#target-content").load("pagination3.php?page=" + pageNum);
        });
    });
</script>
