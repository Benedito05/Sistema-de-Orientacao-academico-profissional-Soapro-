...
$connexao = connexao();
$limit = 4;
$sql = "SELECT COUNT(id_curso) FROM curso_superior";
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="courses_search_container">
                            <form action="curso_detalhes.php" method="POST" id="courses_search_form" class="courses_search_form d-flex flex-row align-items-center justify-content-start">
                                <!--<input  type="search"  class="courses_search_input" name="pesquisar" placeholder="Procurar Cursos" required="required"> !-->

                                <select name="id_curso" style="width: 100%; color:#007bff;" id="id_universidade" class=" chosen-select">

                                    <option>Pesquise o curso, faculdade, univesidade ou instituto </option>

                                    <?php
                                    $result_fau = "SELECT * FROM cursos_view ORDER BY id_curso";
                                    $resultado_fau = mysqli_query($conecta, $result_fau);
                                    while ($row_cat = mysqli_fetch_assoc($resultado_fau)) {
                                        echo '<option value="' . $row_cat['id_curso'] . '&&' . $row_cat['id_instituicao'] . '">' . ($row_cat['universidade']) . ' | Faculdade: ' . ($row_cat['faculdade']) . ' |  Curso: ' . ($row_cat['nome']) . '</option>';
                                    }
                                    ?>
...
<div><h3>Source code : PHP simaple ajax pagination</h1></div> -->
                                ...
                                <div>
                                    ...
                                    <div class="col-lg-12" style="margin-left: 20%; text-align: center">
                                        <div class="sidebar">
                                    ...
                                    <div class="footer_section footer_contact">
                                        ...
                                        <div class="footer_contact_info">
                                            <ul>
                                                ...
                                                <li> <i class="fa fa-map-marker"> Rua Comandante Valodia/ Luanda, Angola</i>
