<head>
    <title>Universidades Privadas</title>
    <meta charset="utf-8">
...
$sql = "SELECT * FROM instituicao_sup where sector='Privada' AND id_tipo=1  ORDER BY id_instituicao ASC LIMIT $start_from, $limit";
try {
