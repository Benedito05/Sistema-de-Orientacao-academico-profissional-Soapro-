...
$id = (isset($_POST['id_instituicao'])) ? $_POST['id_instituicao'] : (int) $_GET['id_instituicao'];
    ...
    $show_cursos .= '<div class="col-lg-6 course_col">
        <div class="course">
            ...
            <div class="course_body">
                ...
                <h3 class="course_title"><a href="curso.php?id_curso=' . $rs->id_curso . '&id_instituicao=' . $id . ' "> <div  class="feature_icon"><i style="color: #007bff; margin-top:-15px" class="fa fa-graduation-cap fa-4x"></i> </div>' . '' . $rs->curso . '</a></h3>
                
                <div class="course_text">
                    <div  class=""><i style="color: #007bff" class="text-center"></i> </div>  <p>Faculdade :  ' . $rs->faculdade . ' </p>
...
<head>
    <title>Ver Curos por Faculdade</title>
    <meta charset="utf-8">
...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="courses_container">
                            <div class="text-center" ><i class=""></i>
                                ...
                                <div>
                                    ...
                                    <div class="col-lg-12" style="margin-left: 5%; text-align: center">
                                        <div class="sidebar">
    ...
    jQuery(document).ready(function() {
        jQuery("#target-content").load("pagination6.php?page=1&id_instituicao=" + $("[name=id_instituicao]").val());
        jQuery("#pagination li").live('click', function(e) {
            ...
            var pageNum = this.id;
            jQuery("#target-content").load("pagination6.php?page=" + pageNum + "&id_instituicao=" + $("[name=id_instituicao]").val());
        });
    });
</script>
