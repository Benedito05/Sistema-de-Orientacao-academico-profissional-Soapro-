...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            <?php
            $id_saida = filter_input(INPUT_GET, 'id_saida', FILTER_SANITIZE_NUMBER_INT);
            $result = mysqli_query($conecta, "SELECT * FROM saida_profissional WHERE id_saida = '$id_saida' LIMIT 1");
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Editar  Saidas Profissionais</h3>
                                </div>
                                <!-- /.box-header -->
                                <!-- form start -->
                                <form  method="POST" action="processa/proc_edit_saida.php">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleimputname">Nome_Curso Superior</label>
                                            <input type="text" class="form-control" id="exampleInputEmail1"  name="nome_curso_superior" placeholder="Digite o  nome do curso superior " value="<?php echo $resultado['nome_curso_superior']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleimputname">Nome_Saida</label>
                                            <input type="text" class="form-control" id="exampleInputEmail1" name="nome_saida" placeholder="Digite a  saida profissional" value=" <?php echo $resultado['nome_saida']; ?>">
                                        </div>

                                        <input type="hidden" name="id_saida" value="<?php echo $resultado['id_saida']; ?>" >
