...
//$id = filter_input(INPUT_GET, 'id_instituicao', FILTER_SANITIZE_NUMBER_INT);
...
<?php
 $id = filter_input(INPUT_GET, 'id_instituicao', FILTER_SANITIZE_NUMBER_INT);
 $result = mysqli_query($conecta,"SELECT * FROM instituicao_sup WHERE id_instituicao = '$id' LIMIT 1");
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Editar Universidades</h3>
                                </div>
                                <!-- /.box-header -->
                                <!-- form start -->
                                <form  method="POST" action="processa/proc_edit_ies.php">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputEmail1" name="nome" placeholder="Digite  o nome da Universidade" value="<?php echo $resultado['nome_ies']; ?>" >
                                                    

                                        </div>
                                  <div class="form-group">
                                            <label>Sector da Universidade</label>
                                            <select class="form-control select2-dropdown" name="sector">
                                                
                                                <option> Escolha o Sector</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exempleinputarea"  name="localizacao" placeholder="Digite a localização" value="<?php echo $resultado['localizacao']; ?>" >
                                        </div>
                                         <div class="form-group">
                                            <label for="exampleimputname">Email</label>
                                            <input type="text" class="form-control" id="exempleinputarea"  name="email" placeholder="exemplo@hotmail.com" value="<?php echo $resultado['email']; ?>" >
                                        </div>
                                         <div class="form-group">
                                            <label for="exampleimputname">Telefone</label>
                                            <input type="text" class="form-control" id="exempleinputarea" name="telefone" placeholder="Digite o numero de telefone" value="<?php echo $resultado['telefone']; ?>" >
                                        </div>
                                    ...
                                    <div class="form-group">
                                            ...
                                            <input type="hidden"  name="id_instituicao"  value="<?php echo $resultado['id_instituicao']; ?>" >
                                        </div>
                                    <div class="box-footer">
                                        <button type="submit" class="btn btn-primary">Editar Universidade</button>
                                    </div>
                             </form>
                        </div>
