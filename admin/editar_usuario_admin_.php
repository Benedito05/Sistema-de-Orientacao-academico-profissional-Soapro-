...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            $id = $_GET['id_usuario'];
            //echo "$id";
            $result = mysqli_query($conecta, "SELECT * FROM usuarios WHERE id_usuario = '$id' LIMIT 1");
                                ...
                                <form  method="POST" action="processa/proc_edit_usuario.php">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleimputname">Nome do Usuario</label>
                                            <input type="text" class="form-control" id="exampleInputEmail1" name="nome" placeholder="Digite  o nome da Universidade" value="<?php echo $resultado['nome']; ?>" >
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleimputname">Usuario</label>
                                            <input type="text" class="form-control" id="exempleinputarea"  name= "usuario" placeholder="Digite a localização" value="<?php echo $resultado['usuario']; ?>" >
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleimputname">Senha</label>
                                            <input type="password" class="form-control" id="exempleinputarea"  name= "senha" placeholder="Digite a Senha" value="<?php echo $resultado['senha']; ?>" >
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleimputname">Email</label>
                                            <input type="email" class="form-control" id="exempleinputarea" name=" email" placeholder="exemplo@hotmail.com" value="<?php echo $resultado['email']; ?>" >
                                        </div>
                                        <div class="form-group">
                                            <label>Nivel de Acesso</label>
                                            <select class="form-control select2-dropdown" name=" Nivel_Acesso"  value="<?php echo $resultado['Nivel_Acesso']; ?>"  >
