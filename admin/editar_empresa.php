...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            $result = mysqli_query($conecta, "SELECT * FROM empresas WHERE id_empresa = '$id_empresa' LIMIT 1");
            ...
            <header class="main-header">
                ...
                <a href="index.php" class="logo">
                    ...
                    <span class="logo-mini"><b>SIG_OAP</b></span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg"><b> SIG_OAP</b></span>
                </a>
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="active treeview-menu">
                            <a href="index.php">
                                <i class="fa fa-dashboard"></i> <span>SIG_OAP</span>
                            </a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                ...
                                <!-- /.box-header -->
                                <!-- form start -->
                                <form  method="POST" action="processa/proc_edit_empresa.php">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleimputname">Nome</label>
                                            <input type="text" class="form-control" id="exampleInputEmail1"  name="nome" placeholder="Digite o  nome do curso superior " value="<?php echo $resultado['nome']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleimputname">Descricao</label>
                                            <input type="text" class="form-control" id="exampleInputEmail1" name="descricao" placeholder="Digite a  saida profissional" value=" <?php echo $resultado['descricao']; ?>">
                                        </div>
                                          <div class="form-group">
                                            <label for="exampleimputname">Area</label>
                                            <input type="text" class="form-control" id="exampleInputEmail1" name="area" placeholder="Digite a  saida profissional" value=" <?php echo $resultado['area']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleimputname">sector</label>
                                            <input type="text" class="form-control" id="exampleInputEmail1" name="sector" placeholder="Digite a  saida profissional" value=" <?php echo $resultado['sector']; ?>">
                                        </div>

                                        <input type="hidden" name="id_empresa" value="<?php echo $resultado['id_empresa']; ?>" >
...
<footer class="main-footer">
    ...
    <strong>Copyright &copy;2019 <a href="">SIG_OAP</a>.</strong> Todos os Direitos reservados.
