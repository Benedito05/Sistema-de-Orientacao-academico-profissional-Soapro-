                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="dist/img/business_user.png" class="user-image" alt="User Image">
                                    <span class="hidden-xs"><?php echo "Bem-Vindo/a : " . $_SESSION['AdminNome'];
?>  </span>
                                </a>
                                <ul class="dropdown-menu">
                                    <!-- User image -->
                                    <li class="user-header">
                                        <img src="dist/img/business_user.png" class="img-circle" alt="User Image">

                                        <p>
                                            <?php echo "Bem-Vindo/a : " . $_SESSION['AdminNome'];
                                            ?>  
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="ver_denuncia.php"><i class="fa fa-circle-o"></i> Ver mensagens</a></li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Cadastro de Saidas Profissionais</h3>
                                </div>
                                <!-- /.box-header -->
                                <!-- form start -->
                                <form  method="POST" action="processa/proc_cad_saida.php">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <select name="id_curso" style="width: 100%; height: 5%">
                                        ...
                                        <input type="hidden" name="id_saida">
