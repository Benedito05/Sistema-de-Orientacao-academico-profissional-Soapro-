...
$result_usuario = "SELECT * from  instituicao_sup";
...
<br>
  ...
  <h2 style='text-align:center; margin-top:2%'>Relatório de Universidades e Institutos</h2>
  </div>
 <br>
</div>
    ...
    <thead>
        <tr class=''>
            ...
            <th>Universidade ou Instituto</th>
            <th>Sector</th>
        </tr>
    </thead>
